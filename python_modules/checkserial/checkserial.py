...
class checkserial():
	...
	def open_serial(self):
		...
		self.exit_signal = int(cfg.get("SIGNAL", "EXITFLAG"))
		self.serial_ok_sig = int(cfg.get("SIGNAL", "GSMSERIALOK"))
		self.gsm_sim_not_inserted_sig = int(cfg.get("SIGNAL", "GSMSIMNOTINSERTED"))
		self.gsm_sim_module_error_sig = int(cfg.get("SIGNAL", "GSMSIMMODULEERROR"))
